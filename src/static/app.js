            ...
            details.participants.forEach((email) => {
              ...
              participantsHtml += `
                <div class="participant-item">
                  ...
                  <span class="delete-participant" title="Remove participant" data-activity="${name}" data-email="${email}" style="cursor:pointer; margin-left:8px; color:#c62828; font-size:18px;" aria-label="Delete participant">&#x2716;</span>
                </div>
              `;
            });
